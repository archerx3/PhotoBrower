...
class AWZoomingImageView: UIScrollView, UIScrollViewDelegate {
    
    /// Tap gesture recognizer for zooming.
    fileprivate(set) var doubleTapGestureRecognizer = UITapGestureRecognizer()
    
    weak var zoomScaleDelegate: AWZoomingImageViewDelegate?
...
protocol AWZoomingImageViewDelegate: class {
