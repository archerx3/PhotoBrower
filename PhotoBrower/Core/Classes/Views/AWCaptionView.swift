...
open class AWCaptionView: UIView, AWCaptionViewProtocol {
    ...
    open var defaultTitleAttributes: [NSAttributedString.Key: Any] {
        get {
    ...
    open var defaultDescriptionAttributes: [NSAttributedString.Key: Any] {
        get {
            var fontDescriptor: UIFontDescriptor
            if #available(iOS 10.0, tvOS 10.0, *) {
                fontDescriptor = UIFontDescriptor.preferredFontDescriptor(withTextStyle: .body,
    ...
    open var defaultCreditAttributes: [NSAttributedString.Key: Any] {
        get {
            var fontDescriptor: UIFontDescriptor
            if #available(iOS 10.0, tvOS 10.0, *) {
    ...
    open override func layoutSubviews() {
        ...
        if self.animateCaptionInfoChanges && self.needsCaptionLayoutAnim {
            ...
            DispatchQueue.main.async { [weak self] in
                ...
                UIView.animate(withDuration: AWConstants.frameAnimDuration / 2,
                               delay: 0,
