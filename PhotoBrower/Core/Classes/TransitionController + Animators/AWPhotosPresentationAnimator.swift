//
//  AWPhotosPresentationAnimator.swift
//  PhotoBrower
//
...
class AWPhotosPresentationAnimator: AWPhotosTransitionAnimator {
    ...
    override func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let startingViewContainer = AWImageViewTransitionContainer(imageView: startingView.aw_copy())
